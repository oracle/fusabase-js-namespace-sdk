...
export class GithubAuthProvider extends AuthProvider {
  ...
  /**
   * Sign-in method for GitHub.
   * @type {string}
   */
  static GITHUB_SIGN_IN_METHOD = "github";

  /**
   * Provider ID for GitHub authentication.
   * @type {string}
   */
  static PROVIDER_ID = 'github';
  ...
  /**
   * Creates an OAuthCredential for GitHub.
