...
/**
 * Represents an IDCS authentication provider.
...
export class IDCSAuthProvider extends AuthProvider {
  ...
  /**
   * Sign-in method for IDCS.
   * @type {string}
   */
  static IDCS_SIGN_IN_METHOD = "idcs";

  /**
   * Provider ID for IDCS authentication.
   * @type {string}
   */
  static PROVIDER_ID = 'idcs';

  /**
   * Creates a new IDCSAuthProvider.
   */
  constructor() {
  ...
  /**
   * Creates an OAuthCredential for IDCS.
