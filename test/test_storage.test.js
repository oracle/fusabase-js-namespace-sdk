...
describe("OBAAS Storage Tests", function () {
    this.timeout(30000);
    ...
    it("should upload, fetch URL, metadata, list, and delete", async function () {
        ...
        const snapshot = await ref3.put(bytes);

        const url = await ref3.getDownloadURL();
        expect(url).to.be.a("string");

        const meta = await ref3.getMetadata();
